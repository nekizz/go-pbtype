...
var (
	filter_EmployeeService_List_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	pattern_EmployeeService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"employee"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"employee", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"employee", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"employees"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"employee", "id"}, "", runtime.AssumeColonVerbOpt(true)))
)
