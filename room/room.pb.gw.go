...
/*
Package room is a reverse proxy.
...
var (
	pattern_PaymentService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"room"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PaymentService_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"room", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PaymentService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"room", "id"}, "", runtime.AssumeColonVerbOpt(true)))
